...
def get_variant_spec_base(universe, domain, task, policy, algorithm, env_params):
    ...
    env_kwargs = env_params.get('kwargs_env', {})
    if 'kwargs_env' in env_params.keys():
        del env_params['kwargs_env']
    algorithm_params = deep_update(
        algorithm_params,
        env_params
    )
    ...
    variant_spec = {
        ...
        'run_params': {
            ...
            'checkpoint_frequency': 10, #NUM_EPOCHS_PER_DOMAIN.get(domain, DEFAULT_NUM_EPOCHS) // NUM_CHECKPOINTS,
            'checkpoint_replay_pool': False,
        },
    }
    # print(variant_spec['environment_params'])
    # while True:
    #     continue
