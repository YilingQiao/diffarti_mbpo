...
def create_GLearn_algorithm(variant, *args, **kwargs):
    from mbpo.algorithms.glearn import GLearn

    algorithm = GLearn(*args, **kwargs)

    return algorithm

def create_GLearnPolicy_algorithm(variant, *args, **kwargs):
    from mbpo.algorithms.glearnpolicy import GLearnPolicy

    algorithm = GLearnPolicy(*args, **kwargs)

    return algorithm

def create_GLearnOld_algorithm(variant, *args, **kwargs):
    from mbpo.algorithms.glearnold import GLearnOld

    algorithm = GLearnOld(*args, **kwargs)
...
ALGORITHM_CLASSES = {
    ...
    'GLearn': create_GLearn_algorithm,
    'GLearnPolicy': create_GLearnPolicy_algorithm,
    'GLearnOld': create_GLearnOld_algorithm,
}
